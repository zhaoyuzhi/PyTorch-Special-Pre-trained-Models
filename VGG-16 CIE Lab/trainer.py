...
import network_Lab_VGG
import dataset_Lab_ImageNet
import utils
...
def Trainer(opt):
    ...
    if opt.pre_train == True:
        net = network_Lab_VGG.LabVGG16_FC_BN()
    ...
    # Define the dataset
    trainset = dataset_Lab_ImageNet.LabImageNetTrain(opt.baseroot, imglist, stringlist, scalarlist)
