...
import network_RGB_ResNet
import dataset_RGB_ImageNet
import utils
...
def Trainer(opt):
    ...
    if opt.pre_train == True:
        net = network_RGB_ResNet.resnet50()
    ...
    # Define the dataset
    trainset = dataset_RGB_ImageNet.ImageNetTrain(opt.baseroot, imglist, stringlist, scalarlist)
