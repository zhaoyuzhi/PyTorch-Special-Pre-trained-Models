...
def get_gray(img):
    ...
    img = img.resize((224, 224), Image.ANTIALIAS).convert('RGB')          # PIL Image L: L [0, 255], order [H, W]
...
if __name__ == "__main__":
    ...
    # Pre-trained VGG-16
    vgg16 = torch.load('./ResNet50_RGB_IN_epoch5_batchsize64.pth').cuda()
    vgg16.eval()
    # Read all names
    ...
    # Define imgpath
    basepath = 'C:\\Users\\yzzha\\Desktop\\dataset\\ILSVRC2012_val_256\\'
    # Define the name you want to save as
    base = 'epoch 120 / ResNet-50 RGB'
