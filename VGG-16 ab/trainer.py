...
import network_ab_VGG
import dataset_ab_ImageNet
import utils
...
def Trainer(opt):
    ...
    if opt.pre_train == True:
        net = network_ab_VGG.abVGG16_FC_BN()
    ...
    # Define the dataset
    trainset = dataset_ab_ImageNet.abImageNetTrain(opt.baseroot, imglist, stringlist, scalarlist)
