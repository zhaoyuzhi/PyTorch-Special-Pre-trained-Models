...
if __name__ == "__main__":
    ...
    parser.add_argument('--baseroot', type = str, default = "/media/ztt/6864FEA364FE72E4/zhaoyuzhi/ILSVRC2012_train256/",
    ...
    parser.add_argument('--pre_train', type = bool, default = False, help = 'pre-trained model exists ot not')
