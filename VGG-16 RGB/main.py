...
if __name__ == "__main__":
    ...
    parser.add_argument('--baseroot', type = str, default = "C:\\Users\\ZHAO Yuzhi\\Desktop\\dataset\\ILSVRC2012_train_256\\",
    ...
    parser.add_argument('--load_type', type = str, default = "RGBVGG16_FC_BN",
        help = 'load_type: load the model corresponding to network type; there are 3 types: RGBVGG16 | RGBVGG16_BN | RGBVGG16_FC_BN')
    parser.add_argument('--load_epoch', type = str, default = "10", help = 'load id: load the model corresponding to certain epoch')
    parser.add_argument('--load_batchsize', type = str, default = "32", help = 'load id: load the model corresponding to certain batchsize')
