...
#-----------------------------------------------
#           VGG16 for RGB color space
#-----------------------------------------------
class RGBVGG16(nn.Module):
    def __init__(self, in_dim = 3, num_classes = 1000):
        super(RGBVGG16, self).__init__()
...
class RGBVGG16_BN(nn.Module):
    def __init__(self, in_dim = 3, num_classes = 1000):
        super(RGBVGG16_BN, self).__init__()
        # feature extraction part
        self.conv1 = nn.Sequential(
            nn.Conv2d(in_channels = in_dim, out_channels = 64, kernel_size = 3, stride = 1, padding = 1),
            nn.BatchNorm2d(64),
...
# Fully convolutional layers in feature extraction part compared to RGBVGG16_BN
...
class RGBVGG16_FC_BN(nn.Module):
    def __init__(self, in_dim = 3, num_classes = 1000):
